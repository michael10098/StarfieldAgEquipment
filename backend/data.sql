-- Farm Customer Database Seed Script for SQLite
...
INSERT INTO farm_customer (
  ...
  1, 3, '2024-10-15', 'Annual winter maintenance scheduled', 'Well-maintained, proactive about servicing',
  ...
  1, 'EMAIL, TEXT', 'Annual customer appreciation event, 2 field days', 'Facebook', 'Precision agriculture, Fuel-efficient equipment', 'Family relationship since 1978',
...
INSERT INTO farm_customer (
  ...
  1, 8, '2024-11-13', 'Pre-season equipment check scheduled for spring', 'Fleet is well-maintained, operates custom harvesting business',
  ...
  1, 'EMAIL', 'VIP customer events, trade shows, 4 field demonstrations', 'Facebook, LinkedIn', 'High-efficiency equipment, Automation, Fleet management', 'Long-term relationship since 1963',
...
INSERT INTO farm_customer (
  ...
  1, 5, '2024-10-28', 'Winter equipment checkup', 'Mix of new and used equipment, cost-conscious buyers',
  ...
  1, 'MAIL, PHONE', 'Occasional - 1-2 events per year', '', 'Value-oriented equipment, Used options', 'Responded to direct mail campaign in 2018',
...
INSERT INTO farm_customer (
  ...
  1, 6, '2024-11-15', 'Scheduled maintenance program in place', 'Invests in technology upgrades, excellent maintenance',
  ...
  1, 'EMAIL, TEXT', 'Regular attendee at field days, customer appreciation events, winter seminars', 'Facebook, Instagram', 'Precision agriculture, Grain handling equipment, Efficiency technology', 'Trade show contact, became customer in 2016',
...
INSERT INTO farm_customer (
  ...
  1, 9, '2024-11-13', 'Winter equipment preparation', 'Hard use conditions, regular wear items needed',
  ...
  1, 'PHONE, TEXT', 'Attends ranch equipment demos, cattlemen''s association meetings', 'Facebook', 'Livestock equipment, Hay machinery, Durable utility tractors', 'Long-term relationship since 1990s',
...
INSERT INTO farm_customer (
  ...
  1, 14, '2024-11-06', 'TMR mixer wagon scheduled maintenance', 'High hours on equipment, daily use conditions',
  ...
  1, 'EMAIL, PHONE', 'Sporadic - attends when schedule permits', 'Facebook', 'Dairy-specific equipment, Feed handling, Manure management', 'Dairy cooperative referral in 2015',
...
INSERT INTO farm_customer (
  ...
  1, 7, '2024-11-16', 'Winter preparation scheduled', 'Well-maintained, focus on livestock handling efficiency',
  ...
  1, 'TEXT, EMAIL', 'Regular - attends livestock equipment demos, cattlemen''s meetings', 'Facebook, Instagram', 'Livestock handling equipment, Feed equipment, Animal welfare technology', 'Cattlemen''s association referral in 2018',
...
SELECT '========================================' AS '';
SELECT 'Database Seed Completed Successfully!' AS '';
SELECT '========================================' AS '';
SELECT '' AS '';
SELECT 'Summary Statistics:' AS '';
SELECT '-------------------' AS '';
SELECT COUNT(*) AS 'Total Customers' FROM farm_customer;
SELECT COUNT(*) AS 'Total Crops' FROM crop;
SELECT COUNT(*) AS 'Total Livestock' FROM livestock;
SELECT COUNT(*) AS 'Total Production Metrics' FROM production_metric;
SELECT COUNT(*) AS 'Total Equipment Items' FROM equipment_item;
SELECT COUNT(*) AS 'Total Purchases' FROM purchase;
SELECT COUNT(*) AS 'Total Warranties' FROM warranty;
SELECT COUNT(*) AS 'Total Replacement Cycles' FROM replacement_cycle;
SELECT COUNT(*) AS 'Total Trade-ins' FROM trade_in;
SELECT COUNT(*) AS 'Total Insurance Policies' FROM insurance_policy;
SELECT COUNT(*) AS 'Total Contracts' FROM contract;
SELECT COUNT(*) AS 'Total Leases' FROM lease;
SELECT '' AS '';
SELECT '========================================' AS '';
SELECT 'Customer List:' AS '';
SELECT '========================================' AS '';
SELECT legal_name AS 'Legal Name', farm_category AS 'Category', customer_tier AS 'Tier' 
FROM farm_customer 
ORDER BY customer_tier DESC, legal_name;